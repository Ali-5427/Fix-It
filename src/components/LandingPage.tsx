          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-10 lg:gap-12">
            ...
            <div className="md:col-span-4 space-y-4">
              ...
              <div className="pt-2">
                <button
                  onClick={onStartAudit}
                  className="inline-flex items-center gap-1.5 rounded-full bg-blue-600 hover:bg-blue-700 text-white font-bold px-4 py-2 text-xs transition-colors shadow-sm"
                >
            ...
            <div className="md:col-span-8 grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-8 text-xs">
              ...
              {/* Col 1: Product */}
              <div>
                <h4 className="font-mono text-[11px] font-bold uppercase tracking-wider text-slate-400 mb-4">
                  PRODUCT
                </h4>
              ...
              <div>
                ...
                <ul className="space-y-2.5 text-slate-600 font-medium">
                  <li>
                    <button 
                      onClick={() => onOpenAuth ? onOpenAuth('login') : undefined}
                      className="hover:text-blue-600 transition-colors cursor-pointer"
                    >
                      Sign in
                    </button>
                  ...
                  <li>
                    <button 
                      onClick={() => onOpenAuth ? onOpenAuth('register') : undefined}
                      className="hover:text-blue-600 transition-colors cursor-pointer"
                    >
                      Create Account
                    </button>
              ...
              <div>
                ...
                <ul className="space-y-2.5 text-slate-600 font-medium">
                  ...
                  <li>
                    <a href="/dpa" className="hover:text-blue-600 transition-colors">
                      DPA
                    </a>
                  </li>
                  <li>
                  ...
                  <li>
                    <a href="/refunds" className="hover:text-blue-600 transition-colors">
                      Refunds
                    </a>
                  </li>
                </ul>
