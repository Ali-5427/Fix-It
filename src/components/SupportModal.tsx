...
export const SupportModal: React.FC<SupportModalProps> = ({ isOpen, onClose }) => {
  ...
  const handleCopyEmail = () => {
    navigator.clipboard.writeText('support@fixit-preflight.dev');
    setCopiedEmail(true);
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="p-3.5 rounded-xl bg-blue-50/80 border border-blue-200/80 flex items-center justify-between gap-3 text-xs">
                <div className="flex items-center gap-2 text-blue-900">
                  ...
                  <span>Direct email: <strong className="font-mono">support@fixit-preflight.dev</strong></span>
                </div>
                <button
                  type="button"
