          ...
          {activeTab === 'preferences' && (
            <div className="space-y-5">
              ...
              <div className="pt-4 border-t border-slate-200 space-y-3">
                <h4 className="text-xs font-bold text-red-600 uppercase font-mono">Data Management & Reset</h4>
                <div className="flex items-center justify-between rounded-xl border border-red-200 bg-red-50/30 p-3.5">
                  <div>
                    <strong className="text-xs text-red-900 block">Reset Sandbox Demo State</strong>
                    <span className="text-[11px] text-red-700">Restore default demo apps (FocusFlow, FitTrack, QuickScan) and sample audit runs.</span>
                  </div>
                  <button
                    type="button"
                    onClick={() => {
