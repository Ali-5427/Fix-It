...
export function createServerApp() {
  ...
  app.get('/api/admin/stats', (req: Request, res: Response) => {
    res.json({
      ...
      failedJobs: 3,
      mostCommonFindings: [
        { ruleId: 'RULE-PRIV-01', title: 'Missing or Incomplete Privacy Manifest (PrivacyInfo.xcprivacy)', count: 215, category: 'PRIVACY' },
        { ruleId: 'RULE-ACC-01', title: 'Missing In-App Account Deletion Capability', count: 184, category: 'ACCOUNT_REQUIREMENTS' },
        { ruleId: 'RULE-PERM-01', title: 'Vague or Terse Permission Purpose Strings', count: 162, category: 'PERMISSIONS' },
        { ruleId: 'RULE-ACC-02', title: 'Missing Sign in with Apple When Social Login is Present', count: 128, category: 'ACCOUNT_REQUIREMENTS' },
        { ruleId: 'RULE-SUB-01', title: 'Missing Restore Purchases Button on Paywall', count: 96, category: 'SUBSCRIPTIONS' }
      ],
      activeRuleCount: APP_STORE_RULES.length,
      rulesLastReviewed: '2026-06-15',
      aiUsageCount: 840
    });
  });
